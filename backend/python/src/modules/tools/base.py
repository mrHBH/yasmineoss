...
class CodeEditorTooling:
    def __init__(self, filename="persistent_source.py", interpreter="python3") -> None:
        ...
        self.lastExecuterStdout = ""
        self.lastExecuterStderr = ""
        self.task = ""
    ...
    def load_code(self, *args, **kwargs):
        with open(self.filename, "r") as fp:
            self.source_code = fp.readlines()
    ...
    def run_code(self, *args, **kwargs):
        ...
        self.lastExecuterStderr = completed_process.stderr
        self.lastExecuterStdout = completed_process.stdout

        return f"Program {succeeded}\nStdout:{      self.lastExecuterStdout}\nStderr:{self.lastExecuterStderr }"
