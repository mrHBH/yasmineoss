    ...
    processBatch(data) {
        ...
        for (const objData of objects) {
            ...
            if (result) {
                ...
                // Add distance results only when we have valid results
                ...
                // For objects without mode changes, still calculate distance for z-ordering
                const distanceResult = this.getDistanceToOptimized(camera, objData);
                distanceResults.push({
                    id: objData.id,
                    distance: distanceResult.distance,
                    orthogonalDistance: distanceResult.orthogonalDistance
                });
            }
        }
